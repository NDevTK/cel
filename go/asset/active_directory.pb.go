...
type RegistryValue struct {
	...
	Name string `protobuf:"bytes,1,opt,name=name" json:"name,omitempty"`
	// These values correspond to registry value types. Obviously only one of these can be specified.
	//
	// Types that are valid to be assigned to ValueType:
	//	*RegistryValue_StringValue
	//	*RegistryValue_ExpandStringValue
	//	*RegistryValue_BinaryValue
	//	*RegistryValue_DwordValue
	//	*RegistryValue_QwordValue
	//	*RegistryValue_MultiStringValue
	ValueType isRegistryValue_ValueType `protobuf_oneof:"value_type"`
}
...
type isRegistryValue_ValueType interface {
	isRegistryValue_ValueType()
}

type RegistryValue_StringValue struct {
	StringValue string `protobuf:"bytes,10,opt,name=string_value,json=stringValue,oneof"`
}
type RegistryValue_ExpandStringValue struct {
	ExpandStringValue string `protobuf:"bytes,11,opt,name=expand_string_value,json=expandStringValue,oneof"`
}
type RegistryValue_BinaryValue struct {
	BinaryValue []byte `protobuf:"bytes,12,opt,name=binary_value,json=binaryValue,proto3,oneof"`
}
type RegistryValue_DwordValue struct {
	DwordValue int32 `protobuf:"varint,13,opt,name=dword_value,json=dwordValue,oneof"`
}
type RegistryValue_QwordValue struct {
	QwordValue int64 `protobuf:"varint,14,opt,name=qword_value,json=qwordValue,oneof"`
}
type RegistryValue_MultiStringValue struct {
	MultiStringValue *RegistryValue_MultiString `protobuf:"bytes,15,opt,name=multi_string_value,json=multiStringValue,oneof"`
}

func (*RegistryValue_StringValue) isRegistryValue_ValueType()       {}
func (*RegistryValue_ExpandStringValue) isRegistryValue_ValueType() {}
func (*RegistryValue_BinaryValue) isRegistryValue_ValueType()       {}
func (*RegistryValue_DwordValue) isRegistryValue_ValueType()        {}
func (*RegistryValue_QwordValue) isRegistryValue_ValueType()        {}
func (*RegistryValue_MultiStringValue) isRegistryValue_ValueType()  {}

func (m *RegistryValue) GetValueType() isRegistryValue_ValueType {
	if m != nil {
		return m.ValueType
	}
	return nil
...
func (m *RegistryValue) GetStringValue() string {
	if x, ok := m.GetValueType().(*RegistryValue_StringValue); ok {
		return x.StringValue
	}
	return ""
}

func (m *RegistryValue) GetExpandStringValue() string {
	if x, ok := m.GetValueType().(*RegistryValue_ExpandStringValue); ok {
		return x.ExpandStringValue
	}
	return ""
}

func (m *RegistryValue) GetBinaryValue() []byte {
	if x, ok := m.GetValueType().(*RegistryValue_BinaryValue); ok {
		return x.BinaryValue
	}
	return nil
}

func (m *RegistryValue) GetDwordValue() int32 {
	if x, ok := m.GetValueType().(*RegistryValue_DwordValue); ok {
		return x.DwordValue
	}
	return 0
}

func (m *RegistryValue) GetQwordValue() int64 {
	if x, ok := m.GetValueType().(*RegistryValue_QwordValue); ok {
		return x.QwordValue
	}
	return 0
}

func (m *RegistryValue) GetMultiStringValue() *RegistryValue_MultiString {
	if x, ok := m.GetValueType().(*RegistryValue_MultiStringValue); ok {
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*RegistryValue) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _RegistryValue_OneofMarshaler, _RegistryValue_OneofUnmarshaler, _RegistryValue_OneofSizer, []interface{}{
		(*RegistryValue_StringValue)(nil),
		(*RegistryValue_ExpandStringValue)(nil),
		(*RegistryValue_BinaryValue)(nil),
		(*RegistryValue_DwordValue)(nil),
		(*RegistryValue_QwordValue)(nil),
		(*RegistryValue_MultiStringValue)(nil),
	}
}

func _RegistryValue_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*RegistryValue)
	// value_type
	switch x := m.ValueType.(type) {
	case *RegistryValue_StringValue:
		b.EncodeVarint(10<<3 | proto.WireBytes)
		b.EncodeStringBytes(x.StringValue)
	case *RegistryValue_ExpandStringValue:
		b.EncodeVarint(11<<3 | proto.WireBytes)
		b.EncodeStringBytes(x.ExpandStringValue)
	case *RegistryValue_BinaryValue:
		b.EncodeVarint(12<<3 | proto.WireBytes)
		b.EncodeRawBytes(x.BinaryValue)
	case *RegistryValue_DwordValue:
		b.EncodeVarint(13<<3 | proto.WireVarint)
		b.EncodeVarint(uint64(x.DwordValue))
	case *RegistryValue_QwordValue:
		b.EncodeVarint(14<<3 | proto.WireVarint)
		b.EncodeVarint(uint64(x.QwordValue))
	case *RegistryValue_MultiStringValue:
		b.EncodeVarint(15<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.MultiStringValue); err != nil {
			return err
		}
	case nil:
	default:
		return fmt.Errorf("RegistryValue.ValueType has unexpected type %T", x)
	}
	return nil
}

func _RegistryValue_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*RegistryValue)
	switch tag {
	case 10: // value_type.string_value
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.ValueType = &RegistryValue_StringValue{x}
		return true, err
	case 11: // value_type.expand_string_value
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.ValueType = &RegistryValue_ExpandStringValue{x}
		return true, err
	case 12: // value_type.binary_value
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeRawBytes(true)
		m.ValueType = &RegistryValue_BinaryValue{x}
		return true, err
	case 13: // value_type.dword_value
		if wire != proto.WireVarint {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeVarint()
		m.ValueType = &RegistryValue_DwordValue{int32(x)}
		return true, err
	case 14: // value_type.qword_value
		if wire != proto.WireVarint {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeVarint()
		m.ValueType = &RegistryValue_QwordValue{int64(x)}
		return true, err
	case 15: // value_type.multi_string_value
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(RegistryValue_MultiString)
		err := b.DecodeMessage(msg)
		m.ValueType = &RegistryValue_MultiStringValue{msg}
		return true, err
	default:
		return false, nil
	}
...
func _RegistryValue_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*RegistryValue)
	// value_type
	switch x := m.ValueType.(type) {
	case *RegistryValue_StringValue:
	...
	case *RegistryValue_ExpandStringValue:
		...
		n += proto.SizeVarint(uint64(len(x.ExpandStringValue)))
		n += len(x.ExpandStringValue)
	case *RegistryValue_BinaryValue:
	...
	case *RegistryValue_DwordValue:
		...
		n += proto.SizeVarint(uint64(x.DwordValue))
	case *RegistryValue_QwordValue:
		n += proto.SizeVarint(14<<3 | proto.WireVarint)
		n += proto.SizeVarint(uint64(x.QwordValue))
	case *RegistryValue_MultiStringValue:
		s := proto.Size(x.MultiStringValue)
...
type RegistryValue_MultiString struct {
...
func (m *RegistryValue_MultiString) Reset()                    { *m = RegistryValue_MultiString{} }
func (m *RegistryValue_MultiString) String() string            { return proto.CompactTextString(m) }
func (*RegistryValue_MultiString) ProtoMessage()               {}
func (*RegistryValue_MultiString) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{8, 0} }

func (m *RegistryValue_MultiString) GetValue() []string {
	if m != nil {
		return m.Value
	}
	return nil
...
type WindowsMachine struct {
	...
	Container *WindowsContainer `protobuf:"bytes,10,opt,name=container" json:"container,omitempty"`
	...
	WindowsFeature []string `protobuf:"bytes,13,rep,name=windows_feature,json=windowsFeature" json:"windows_feature,omitempty"`
	// Registry keys to set on the machine. These will be applied prior to the
	// user login.
	RegistryKey []*RegistryKey `protobuf:"bytes,14,rep,name=registry_key,json=registryKey" json:"registry_key,omitempty"`
	// A configuration file. Specify this if you've run Windows Server Manager
	// and produced a configration file already.
	ConfigurationFile *common1.FileReference `protobuf:"bytes,15,opt,name=configuration_file,json=configurationFile" json:"configuration_file,omitempty"`
}
...
func (*WindowsMachine) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{15} }
...
func init() {
	...
	proto.RegisterType((*RegistryValue_MultiString)(nil), "asset.RegistryValue.MultiString")
...
var fileDescriptor0 = []byte{
	...
	,
}
