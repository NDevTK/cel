...
func (*windowsContainer) ResolveAdditionalDependencies(ctx common.Context, u *asset.WindowsContainer) (err error) {
	if u == nil {
		return nil
	}

	adContainer, ok := u.Container.(*asset.WindowsContainer_AdDomain)
	if ok {
