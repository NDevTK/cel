...
type Project struct {
	...
	// The full GCP project name if the name cannot be represented as a label.
	// E.g. this would be the case for project names of the form
	// "foo.example.com:project".
...
func (m *Project) GetFullName() string {
	if m != nil {
		return m.FullName
	}
	return ""
...
var fileDescriptor0 = []byte{
	...
	,
}
