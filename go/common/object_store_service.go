...
type ObjectStoreService interface {
	...
	PutNamedObject(ctx context.Context, name string, content []byte, result chan<- error)
...
func ObjectStoreServiceFromContext(ctx context.Context) (ObjectStoreService, error) {
